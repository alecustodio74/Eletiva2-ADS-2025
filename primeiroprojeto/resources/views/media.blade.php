...
<title>Calcular Média em Laravel</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" >
</head>
<body> 
<div class="container">
<h1>Média entre 3 notas em Laravel</h1>
<form method="post" action="/resposta_media">
    @CSRF
<div class="mb-3">
    ...
    <input type="number" id="valor3" name="nota3" class="form-control" required="">
</div>
